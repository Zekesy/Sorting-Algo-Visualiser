...
from Algorithms import linear_sort
...
def StartAlgorithm():
    ...
    elif algMenu.get() == 'Linear Sort':
        linear_sort(data, drawData, speedScale.get())
...
algMenu = ttk.Combobox(UI_frame, textvariable=selected_alg, values=['Bubble Sort', 'Linear Sort', 'Merge Sort','Quick Sort'])
